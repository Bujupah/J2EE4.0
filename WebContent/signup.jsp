	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top"
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse text-center justify-content-end"
				id="navbarPrimaryContent"></div>
		</div>
	</nav>
	<div class="h-100"
		style="background-image: url(&amp;quot;signup.jpg&amp;quot;); background-position: center; background-size: 100% 100%; background-repeat: no-repeat;">
					...
					<div class="card-body text-center">
						<div class="row mt-5">
							<div class="col-md-12">
								...
								<button
									class="btn btn-icon rounded btn-light mx-1 btn-facebook shadow"
									type="button">
									<i class="fa fa-fw fa-lg fa-facebook-square"></i>
								</button>
								<button
									class="btn btn-icon rounded btn-lg btn-light mx-1 btn-twitter shadow"
									type="button">
									<i class="fa fa-fw fa-2x fa-twitter"></i>
								</button>
								<button
									class="btn btn-icon rounded btn-light mx-1 btn-google shadow"
									type="button">
						...
						<div class="row mt-4 pt-2">
							<div class="col" style="">
								<form method="post" action="join">
									...
									<div class="form-group mb-2">
										<div class="input-group border-0 bg-dark">
											...
											<input type="password" name="repassword" class="form-control"
												id="inlineFormInputGroup" placeholder="Re-type password...">
										</div>
									</div>
									<div class="form-group mb-2">
										<div class="input-group border-0 bg-dark">
											...
											<input type="number" name="phone" class="form-control"
												id="inlineFormInputGroup" placeholder="Phone...">
										</div>
									</div>
									...
									<button type="submit"
										class="btn mt-4 mb-3 rounded btn-lg btn-dark text-body">SIGN
										UP</button>
								</form>
							</div>
						</div>
				...
				<div class="col-md-6 text-center" style="">
					<div class="row h-75">
						<div class="col-md-12 m-5 px-5 pl-5 pr-5 pt-5">
							<h5 class="mx-5 mt-5">
								<b>You have an account ?</b><br>
								<b>Click to log in&nbsp;</b><br>
								<b>now !</b><br>
							</h5>
							<a class="btn btn-dark btn-lg rounded active" href="login.jsp"
								style="">Log in</a>
						</div>
					</div>
				</div>
